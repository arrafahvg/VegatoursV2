...
const fields = [
  ...
  { key: 'description_en', label: 'Description (English)', type: 'richtext', placeholder: 'Supports **bold**, *italics*, - bullet lists, and paragraphs.' },
  { key: 'description_id', label: 'Description (Bahasa Indonesia)', type: 'richtext', placeholder: 'Mendukung **tebal**, *miring*, - daftar, dan paragraf.' },
